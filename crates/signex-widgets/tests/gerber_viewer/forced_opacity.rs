    ...
    () => {
        ...
        mod forced_opacity_tests
        {
            ...
            fn composite(top: Color, bottom: Color) -> Color
            {
                ...
                Color {
                    r: (top.r * top.a
                        + bottom.r * bottom.a * (1.0 - top.a))
                        / alpha,
                    g: (top.g * top.a
                        + bottom.g * bottom.a * (1.0 - top.a))
                        / alpha,
                    b: (top.b * top.a
                        + bottom.b * bottom.a * (1.0 - top.a))
                        / alpha,
                    a: alpha,
                }
            }
            ...
            fn forced_opacity_uses_configured_clamped_alpha()
            {
                ...
                assert_eq!(
                    forced_opacity_color(color, false, 0.60),
                    color,
                );
                assert_eq!(
                    forced_opacity_color(color, true, 0.60).a,
                    0.60,
                );
                assert_eq!(
                    forced_opacity_color(color, true, 2.0).a,
                    1.0,
                );
            }
            ...
            {
                let red = forced_opacity_color(
                    Color::from_rgb8(211, 47, 47),
                    true,
                    0.60,
                );
                let blue = forced_opacity_color(
