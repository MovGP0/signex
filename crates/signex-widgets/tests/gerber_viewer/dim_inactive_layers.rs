    ...
    () => {
        ...
        mod dim_inactive_layers_tests
        {
            ...
            fn active_and_normal_layers_preserve_their_color()
            {
                ...
                assert_eq!(
                    inactive_layer_color(color, true, true, 0.28),
                    color
                );
                assert_eq!(
                    inactive_layer_color(color, false, false, 0.28),
                    color
                );
            }
            ...
            fn inactive_layer_uses_configured_clamped_opacity()
            {
                ...
                let dimmed =
                    inactive_layer_color(color, false, true, 0.28);
                ...
                assert_eq!(
                    inactive_layer_color(color, false, true, 2.0).a,
                    color.a
                );
            }
