...
use crate::binary_tiling::{BinaryTilingHierarchy, smith_binary_tiling};
use crate::tool::smith_chart_y::{
    admittance_chart_point, draw_admittance_grid, draw_admittance_q_arc,
};
use crate::tool::smith_view_navigation::SmithViewNavigationState;
use iced::Event;
...
pub(in crate::tool) fn draw_binary_tiling_grid(
    frame: &mut canvas::Frame,
    center: Point,
    radius: f32,
    reflected: bool,
