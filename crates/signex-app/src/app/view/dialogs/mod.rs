...
/// the button.
pub const MODAL_HEADER_HEIGHT: f32 = 28.0;
...
pub const MODAL_HEADER_PADDING: iced::Padding = iced::Padding {
    top: 0.0,
    right: 0.0,
    bottom: 0.0,
    left: 16.0,
...
pub const MODAL_CLOSE_X_HIT_H: f32 = MODAL_HEADER_HEIGHT;
/// SVG glyph size for the close-X. Same value the chrome close uses.
pub const MODAL_CLOSE_X_ICON: f32 = 14.0;
/// Hover background for the close-X (Windows-native destructive red).
pub const MODAL_CLOSE_X_HOVER: Color = Color::from_rgba(0.78, 0.22, 0.22, 1.0);

pub use widgets::{close_x_button, detached_header};
